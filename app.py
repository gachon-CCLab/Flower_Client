...
def load_partition():
    ...
    (X_train, y_train) = X_train[status.FL_client_num * 5000:(status.FL_client_num + 1) * 5000], y_train[
                                                                           status.FL_client_num * 5000:(status.FL_client_num + 1) * 5000]
    (X_test, y_test) = X_test[status.FL_client_num * 5000:(status.FL_client_num + 1) * 5000], y_test[status.FL_client_num * 5000:(status.FL_client_num + 1) * 5000]
