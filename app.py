...
def load_partition():
    ...
    (X_train, y_train) = X_train[status.FL_client_num * 10000:(status.FL_client_num + 1) * 10000], y_train[
                                                                           status.FL_client_num * 10000:(status.FL_client_num + 1) * 10000]
    (X_test, y_test) = X_test[status.FL_client_num * 10000:(status.FL_client_num + 1) * 10000], y_test[status.FL_client_num * 10000:(status.FL_client_num + 1) * 10000]
